...
/*      name: 'img.src',
    ...
    impl: function(win, url) {
      ...
      popup = win.open('javascript:addEventListener("DOMContentLoaded",function(){location="' + url + '";setTimeout(function(){location="data:text/html,<script>if(opener){opener.postMessage(\'msg\',\''+ win.location.href +'\');setTimeout(function(){opener.postMessage(\'not_installed\',\''+ win.location.href +'\');close()},100)}}</script>"},500);');
    },
  }, {
